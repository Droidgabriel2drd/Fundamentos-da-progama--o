...
dia_semana = input ("Informe o dia da semana - [segunda], [terça], [quarta], [quinta], [sexta], [sábado], [domingo]: ")

print(f" O sabor escolhido é {pizza_sabor}, o tamanho é {pizza_tamanho} e hoje é {dia_semana}.")

# Promoções -> Estruturas condicionais:
# Comprando qualquer pizza de qualquer tamanho no sábado, o refri é gratuito.
